            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="profilDropdown">
                  ...
                  <li><a class="dropdown-item" href="mitrakerja.html">Partnership / Mitra Kerja</a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="sertifikasiDropdown">
                  ...
                  <li><a class="dropdown-item" href="#">Tempat Uji Kompetensi</a></li>
                  <li><a class="dropdown-item" href="#">Asesor Kompetensi</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown">
...
<body>
    <div class="container mt-5">
        ...
        <a href="mitra.php" class="btn btn-primary mb-3">Kembali ke Mitra Kerja</a>
        ...
        <div class="table-responsive">
            <table id="mitra_kerjaTable" class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <th>Nama </th>
                    <th>Alamat</th>
                    <th class="center-text">Kerja Sama</th>
            ...
            <tbody>
                ...
                <td class="center-text"><?= htmlspecialchars($mitra['kerja_sama'] ?? 'Tidak ada kerja sama') ?></td>
